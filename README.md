...
Выводы:      
Во всех наборах все изображения имеют маски и наоборот. Распределение классов сбалансировано. Однако в train авторы задания подкинули явного мусора.      
