...
launcher = 'none'
load_from = 'practicum_work/artifacts/mmsegmentation_work_dir/best_mDice_epoch_80.pth'
log_level = 'INFO'
...
num_workers = 4
optim_wrapper = dict(
    optimizer=dict(lr=0.0002, type='AdamW', weight_decay=0.08),
    type='OptimWrapper')
optimizer = dict(lr=0.0002, type='AdamW', weight_decay=0.08)
param_scheduler = [
    dict(
