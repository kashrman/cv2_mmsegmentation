...
launcher = 'none'
load_from = 'practicum_work/artifacts/mmsegmentation_work_dir/best_mDice_epoch_99_unet_adamw_71.pth'
log_level = 'INFO'
...
num_workers = 4
optim_wrapper = dict(
    optimizer=dict(lr=5e-05, type='AdamW', weight_decay=0.08),
    type='OptimWrapper')
optimizer = dict(lr=5e-05, type='AdamW', weight_decay=0.08)
param_scheduler = [
    dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='data/roboflow_add_cleared',
        img_suffix='.jpg',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
