...
launcher = 'none'
load_from = 'practicum_work/artifacts/mmsegmentation_work_dir/best_mDice_epoch_unet_adamw_73.pth'
log_level = 'INFO'
...
num_workers = 4
optim_wrapper = dict(
    optimizer=dict(lr=0.0005, type='AdamW', weight_decay=0.08),
    type='OptimWrapper')
optimizer = dict(lr=0.0005, type='AdamW', weight_decay=0.08)
param_scheduler = [
    dict(
        begin=0, by_epoch=True, end=100, eta_min=1e-06, power=1,
        type='PolyLR'),
]
resume = False
