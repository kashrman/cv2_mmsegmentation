...
optim_wrapper = dict(
    clip_grad=None,
    optimizer=dict(lr=0.001, type='AdamW', weight_decay=0.001),
    type='OptimWrapper')
optimizer = dict(lr=0.001, type='AdamW', weight_decay=0.001)
param_scheduler = [
    dict(
...
train_cfg = dict(max_epochs=600, type='EpochBasedTrainLoop')
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                transforms=[
                    dict(num_steps=10, p=1, type='GridDistortion'),
                ],
                type='Albu'),
            dict(type='PackSegInputs'),
        ],
