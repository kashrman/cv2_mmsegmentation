...
launcher = 'none'
load_from = 'practicum_work/artifacts/mmsegmentation_work_dir/best_mDice_epoch_final.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir='practicum_work/artifacts/inference_final/test_res',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = './work_dirs/unet1_conf'
